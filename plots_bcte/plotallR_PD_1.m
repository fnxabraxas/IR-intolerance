...
function plotallR_PD_1(i,stgv,ib)

  dirs=strvcat( 'broteT_RT_PD', 'broteR_TT_PD' , 'broteT_RR_PD',   'broteR_TT','broteR_TT',  'broteR_TR','broteR_TR');
  dirlon=[12 12 12   9 9   9 9];
  %colordir=strvcat( 'b', 'y', 'r', 'r' );
  colordir=[ 0.8 0.03 0.03; 0 0.3 1; 0 0 0;    0 0.3 1; 0 0.3 1;   1 1 0; 1 1 0 ];
  transpdir=[1  1 0.5     0 0   0 0];
  lindir= strvcat( 'none', 'none', 'none',   'b', 'none',  'y','none' );
  cambiaY=[ 1 1 0    0 1   1 0];
  figure(1);
