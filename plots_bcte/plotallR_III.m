...
function plotallR_III(i,stgv,ib)

  dirs=strvcat( 'broteT_RT', 'broteT_RR', 'broteR_TR' ); %( 'broteR_TT', 'broteR_TR', 'broteT_RT'); %,'broteT_RT_PD');
  dirlon=[9 9 9 12];
  %colordir=strvcat( 'b', 'y', 'r', 'r' );
  colordir=[ 0.8 0.03 0.03; 0 0 0; 1 1 0 ];
  transpdir=[1 0.5 0.5];
